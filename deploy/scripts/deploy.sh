...
required_variables="EAGLE_IMAGE DEPLOY_ENV EAGLE_DATABASE_DSN EAGLE_AUTH_ISSUER EAGLE_AUTH_CLIENT_ID EAGLE_AUTH_AUDIENCE"
...
write_env() {
  target=$1
  {
    ...
    write_env_value EAGLE_AUTH_REALM_ROLES_CLAIM "${EAGLE_AUTH_REALM_ROLES_CLAIM:-}"
    write_env_value EAGLE_AUTH_CLIENT_ROLES_CLAIM "${EAGLE_AUTH_CLIENT_ROLES_CLAIM:-roles}"
