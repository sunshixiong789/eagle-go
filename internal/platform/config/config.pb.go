...
// 五个字段各是文件里的一个顶层 key（server/data/auth/observability/file）。
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\x15eagle.platform.config\x1a\x1egoogle/protobuf/duration.proto\"\xa1\x02\n" +
	"\tBootstrap\x125\n" +
	...
	"\x04file\x18\x05 \x01(\v2\x1b.eagle.platform.config.FileR\x04file\"I\n" +
	"\x04File\x12\x1b\n" +
...
var file_config_proto_goTypes = []any{
	...
	(*Server_HTTP)(nil),         // 6: eagle.platform.config.Server.HTTP
	(*Server_GRPC)(nil),         // 7: eagle.platform.config.Server.GRPC
...
var file_config_proto_depIdxs = []int32{
	...
	6,  // 5: eagle.platform.config.Server.http:type_name -> eagle.platform.config.Server.HTTP
	7,  // 6: eagle.platform.config.Server.grpc:type_name -> eagle.platform.config.Server.GRPC
	...
	9,  // 9: eagle.platform.config.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	9,  // 10: eagle.platform.config.Data.Database.max_conn_lifetime:type_name -> google.protobuf.Duration
	9,  // 11: eagle.platform.config.Data.Database.max_conn_idle_time:type_name -> google.protobuf.Duration
