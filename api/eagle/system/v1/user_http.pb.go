...
const OperationUserServiceAssignRoles = "/eagle.system.v1.UserService/AssignRoles"
const OperationUserServiceChangeMyPassword = "/eagle.system.v1.UserService/ChangeMyPassword"
const OperationUserServiceCreateUser = "/eagle.system.v1.UserService/CreateUser"
const OperationUserServiceDeleteUser = "/eagle.system.v1.UserService/DeleteUser"
const OperationUserServiceGetUser = "/eagle.system.v1.UserService/GetUser"
const OperationUserServiceListUsers = "/eagle.system.v1.UserService/ListUsers"
const OperationUserServiceResetPassword = "/eagle.system.v1.UserService/ResetPassword"
const OperationUserServiceUpdateUser = "/eagle.system.v1.UserService/UpdateUser"

type UserServiceHTTPServer interface {
	AssignRoles(context.Context, *AssignRolesRequest) (*AssignRolesResponse, error)
	// ChangeMyPassword 当前登录用户改自己的密码。只要登录即可，不需要额外权限码。
...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/v1/system/users", _UserService_CreateUser0_HTTP_Handler(srv))
	r.Handle("GET", "/v1/system/users/{id}", _UserService_GetUser0_HTTP_Handler(srv))
	r.Handle("GET", "/v1/system/users", _UserService_ListUsers0_HTTP_Handler(srv))
	r.Handle("PUT", "/v1/system/users/{id}", _UserService_UpdateUser0_HTTP_Handler(srv))
	r.Handle("DELETE", "/v1/system/users/{id}", _UserService_DeleteUser0_HTTP_Handler(srv))
	r.Handle("POST", "/v1/system/users/{id}/password:reset", _UserService_ResetPassword0_HTTP_Handler(srv))
	r.Handle("PUT", "/v1/system/users/{id}/roles", _UserService_AssignRoles0_HTTP_Handler(srv))
	r.Handle("POST", "/v1/system/users/me/password:change", _UserService_ChangeMyPassword0_HTTP_Handler(srv))
}
...
func _UserService_AssignRoles0_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		reply := out.(*AssignRolesResponse)
		return ctx.Result(200, reply)
	}
}

func _UserService_ChangeMyPassword0_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ChangeMyPasswordRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationUserServiceChangeMyPassword)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ChangeMyPassword(ctx, req.(*ChangeMyPasswordRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ChangeMyPasswordResponse)
		return ctx.Result(200, reply)
	}
}

type UserServiceHTTPClient interface {
	AssignRoles(ctx context.Context, req *AssignRolesRequest, opts ...http.CallOption) (rsp *AssignRolesResponse, err error)
	// ChangeMyPassword 当前登录用户改自己的密码。只要登录即可，不需要额外权限码。
	ChangeMyPassword(ctx context.Context, req *ChangeMyPasswordRequest, opts ...http.CallOption) (rsp *ChangeMyPasswordResponse, err error)
...
func (c *UserServiceHTTPClientImpl) AssignRoles(ctx context.Context, in *AssignRolesRequest, opts ...http.CallOption) (*AssignRolesResponse, error) {
	var out AssignRolesResponse
	pattern := "/v1/system/users/{id}/roles"
	path := http.BuildPath(pattern, in)
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationUserServiceAssignRoles),
...
// ChangeMyPassword 当前登录用户改自己的密码。只要登录即可，不需要额外权限码。
func (c *UserServiceHTTPClientImpl) ChangeMyPassword(ctx context.Context, in *ChangeMyPasswordRequest, opts ...http.CallOption) (*ChangeMyPasswordResponse, error) {
	var out ChangeMyPasswordResponse
	pattern := "/v1/system/users/me/password:change"
	path := http.BuildPath(pattern, in)
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationUserServiceChangeMyPassword),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *UserServiceHTTPClientImpl) ResetPassword(ctx context.Context, in *ResetPasswordRequest, opts ...http.CallOption) (*ResetPasswordResponse, error) {
	...
	pattern := "/v1/system/users/{id}/password:reset"
	path := http.BuildPath(pattern, in)
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationUserServiceResetPassword),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
