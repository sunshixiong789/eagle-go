...
const (
	PermissionService_CreatePermission_FullMethodName = "/eagle.system.v1.PermissionService/CreatePermission"
	PermissionService_GetPermission_FullMethodName    = "/eagle.system.v1.PermissionService/GetPermission"
	PermissionService_ListPermissions_FullMethodName  = "/eagle.system.v1.PermissionService/ListPermissions"
	PermissionService_UpdatePermission_FullMethodName = "/eagle.system.v1.PermissionService/UpdatePermission"
	PermissionService_DeletePermission_FullMethodName = "/eagle.system.v1.PermissionService/DeletePermission"
	PermissionService_GetMyMenus_FullMethodName       = "/eagle.system.v1.PermissionService/GetMyMenus"
)
...
type PermissionServiceClient interface {
	...
	GetMyMenus(ctx context.Context, in *GetMyMenusRequest, opts ...grpc.CallOption) (*GetMyMenusResponse, error)
}
...
func (c *permissionServiceClient) GetMyMenus(ctx context.Context, in *GetMyMenusRequest, opts ...grpc.CallOption) (*GetMyMenusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMyMenusResponse)
	err := c.cc.Invoke(ctx, PermissionService_GetMyMenus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPermissionServiceServer) GetMyMenus(context.Context, *GetMyMenusRequest) (*GetMyMenusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMyMenus not implemented")
}
...
func _PermissionService_GetMyMenus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMyMenusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionServiceServer).GetMyMenus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionService_GetMyMenus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).GetMyMenus(ctx, req.(*GetMyMenusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "eagle.system.v1.PermissionService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMyMenus",
			Handler:    _PermissionService_GetMyMenus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "eagle/system/v1/permission.proto",
}
