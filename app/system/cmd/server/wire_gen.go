...
func wireApp(confServer *conf.Server, confData *conf.Data, auth *conf.Auth, observability *conf.Observability, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	policyStore := data.NewPolicyStore(enforcer, entClient)
	permissionUsecase := biz.NewPermissionUsecase(permissionRepo, policyStore)
	...
	roleBindingUsecase := biz.NewRoleBindingUsecase(policyStore, permissionRepo)
