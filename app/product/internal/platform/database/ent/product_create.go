...
func (_c *ProductCreate) check() error {
	...
	if v, ok := _c.mutation.PriceCents(); ok {
		if err := product.PriceCentsValidator(v); err != nil {
			return &ValidationError{Name: "price_cents", err: fmt.Errorf(`ent: validator failed for field "Product.price_cents": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Active(); !ok {
...
// SetPriceCents sets the "price_cents" field.
func (u *ProductUpsert) SetPriceCents(v int64) *ProductUpsert {
	u.Set(product.FieldPriceCents, v)
	return u
}

// UpdatePriceCents sets the "price_cents" field to the value that was provided on create.
func (u *ProductUpsert) UpdatePriceCents() *ProductUpsert {
	u.SetExcluded(product.FieldPriceCents)
	return u
}

// AddPriceCents adds v to the "price_cents" field.
func (u *ProductUpsert) AddPriceCents(v int64) *ProductUpsert {
	u.Add(product.FieldPriceCents, v)
	return u
}

// SetActive sets the "active" field.
func (u *ProductUpsert) SetActive(v bool) *ProductUpsert {
	u.Set(product.FieldActive, v)
	return u
}

// UpdateActive sets the "active" field to the value that was provided on create.
func (u *ProductUpsert) UpdateActive() *ProductUpsert {
	u.SetExcluded(product.FieldActive)
	return u
}
...
// SetPriceCents sets the "price_cents" field.
func (u *ProductUpsertOne) SetPriceCents(v int64) *ProductUpsertOne {
	return u.Update(func(s *ProductUpsert) {
		s.SetPriceCents(v)
	})
}
...
// AddPriceCents adds v to the "price_cents" field.
func (u *ProductUpsertOne) AddPriceCents(v int64) *ProductUpsertOne {
	return u.Update(func(s *ProductUpsert) {
		s.AddPriceCents(v)
	})
}
...
// UpdatePriceCents sets the "price_cents" field to the value that was provided on create.
func (u *ProductUpsertOne) UpdatePriceCents() *ProductUpsertOne {
	return u.Update(func(s *ProductUpsert) {
		s.UpdatePriceCents()
	})
}
...
// SetActive sets the "active" field.
func (u *ProductUpsertOne) SetActive(v bool) *ProductUpsertOne {
	return u.Update(func(s *ProductUpsert) {
		s.SetActive(v)
	})
}
...
// UpdateActive sets the "active" field to the value that was provided on create.
func (u *ProductUpsertOne) UpdateActive() *ProductUpsertOne {
	return u.Update(func(s *ProductUpsert) {
		s.UpdateActive()
	})
}
...
// SetPriceCents sets the "price_cents" field.
func (u *ProductUpsertBulk) SetPriceCents(v int64) *ProductUpsertBulk {
	return u.Update(func(s *ProductUpsert) {
		s.SetPriceCents(v)
	})
}
...
// AddPriceCents adds v to the "price_cents" field.
func (u *ProductUpsertBulk) AddPriceCents(v int64) *ProductUpsertBulk {
	return u.Update(func(s *ProductUpsert) {
		s.AddPriceCents(v)
	})
}
...
// UpdatePriceCents sets the "price_cents" field to the value that was provided on create.
func (u *ProductUpsertBulk) UpdatePriceCents() *ProductUpsertBulk {
	return u.Update(func(s *ProductUpsert) {
		s.UpdatePriceCents()
	})
}
...
// SetActive sets the "active" field.
func (u *ProductUpsertBulk) SetActive(v bool) *ProductUpsertBulk {
	return u.Update(func(s *ProductUpsert) {
		s.SetActive(v)
	})
}
...
// UpdateActive sets the "active" field to the value that was provided on create.
func (u *ProductUpsertBulk) UpdateActive() *ProductUpsertBulk {
	return u.Update(func(s *ProductUpsert) {
		s.UpdateActive()
	})
}
